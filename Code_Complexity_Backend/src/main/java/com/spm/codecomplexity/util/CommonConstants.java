...
public class CommonConstants {
	...
	public static final String ARITHMETIC_OPERATORS = 
			...
			+ SUB_FIND_PLUS + "|" 
			+ SUB_FIND_MINUS + "|"
			+ SUB_FIND_FORWARD_SLASH + "|"
			+ SUB_FIND_PERCENTAGE + "|" 
			+ SUB_FIND_DOUBLE_PLUS + "|"
			+ SUB_FIND_DOUBLE_MINUS;
	
	public static final String RELATIONAL_OPERATORS = 
			SUB_FIND_DOUBLE_EQUAL + "|"
			+ SUB_FIND_NOT_EQUAL + "|"
			+ SUB_FIND_GREATER_THAN + "|"
			+ SUB_FIND_LESS_THAN + "|"
			+ SUB_FIND_GREATER_THAN_OR_EQUAL + "|"
	...
	public static final String BITWISE_OPERATORS = 
			SUB_FIND_VERTICAL_LINE  + "|" 
			+ SUB_FIND_UP_ARROW  + "|"
			+ SUB_FIND_WAVE_DASH  + "|"
			+ SUB_FIND_DOUBLE_LEFT_ARROW  + "|"
			+ SUB_FIND_DOUBLE_RIGHT_ARROW + "|"
			+ SUB_FIND_TRIBLE_RIGHT_ARROW  + "|"
			+ SUB_FIND_TRIBLE_LEFT_ARROW;
	
	public static final String MISCELLANEOUS_OPERATORS = 
			SUB_FIND_QUOTATION  + "|"
			+ SUB_FIND_DASH_AND_ARROW + "|"
			+ SUB_FIND_DOT + "|"
			+ SUB_FIND_DOUBLE_COLON;
	
	public static final String ASSIGNMENT_OPERATORS = 
			SUB_FIND_PLUS_EQUAL  + "|"
			+ SUB_FIND_MINUS_EQUAL  + "|"
			+ SUB_FIND_ASTERIC_EQUAL  + "|"
			+ SUB_FIND_DIVIDE_EQUAL  + "|"
			+ SUB_FIND_EQUAL  + "|"
			+ SUB_FIND_TRIBLE_RIGHT_ARROW_EQUAL  + "|"
			+ SUB_FIND_VERTICAL_EQUAL  + "|"
			+ SUB_FIND_AND_EQUAL  + "|"
			+ SUB_FIND_PERCENTAGE_EQUAL  + "|"
			+ SUB_FIND_LEFT_DOUBLE_ARROW_EQUAL  + "|"
			+ SUB_FIND_RIGHT_DOUBLE_ARROW_EQUAL  + "|"
			+ SUB_FIND_UP_ARROW_EQUAL;
	
	public static final String KEYWORDS = 
			SUB_FIND_KEYWORD_VOID + "|"
			+ SUB_FIND_KEYWORD_DOUBLE  + "|"
			+ SUB_FIND_KEYWORD_INT  + "|"
			+ SUB_FIND_KEYWORD_FLOAT  + "|"
			+ SUB_FIND_KEYWORD_STRING  + "|"
			+ SUB_FIND_KEYWORD_PRINTF  + "|"
			+ SUB_FIND_KEYWORD_PRINTLN  + "|"
			+ SUB_FIND_KEYWORD_COUT  + "|"
			+ SUB_FIND_KEYWORD_CIN  + "|"
			+ SUB_FIND_KEYWORD_IF  + "|" 
			+ SUB_FIND_KEYWORD_FOR  + "|"
			+ SUB_FIND_KEYWORD_WHILE  + "|"
			+ SUB_FIND_KEYWORD_DO_WHILE  + "|"
			+ SUB_FIND_KEYWORD_SWITCH  + "|"
			+ SUB_FIND_KEYWORD_CASE + "|"
			+ SUB_FIND_KEYWORD_SYSTEM + "|" 
			+ SUB_FIND_KEYWORD_OUT + "|" 
			+ SUB_FIND_KEYWORD_LONG + "|"
			+ SUB_FIND_KEYWORD_ARGS + "|"
			+ SUB_FIND_KEYWORD_MAIN;
