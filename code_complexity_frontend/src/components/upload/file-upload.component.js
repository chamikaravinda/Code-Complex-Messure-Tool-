    ...
    return (<tr>
        ...
        <td>
            <div className= 'btn-group'>
                <button type = "button" onClick={props.fileDelete} className='btn btn-danger'> Delete </button>
                <Link to = {'/analyse/' + props.file._id }  className='btn btn-primary' > Analyse </Link>
            </div>
        </td>
    </tr>)
}
...
class FileUpload extends Component {
    ...
    onClickUpload(e){
        ...
        axios.post(constants.url  + "/upload/file" , formData )
            .then(res=>{
    ...
    loadAllFiles(){
        axios.get(constants.url + "/file/all")
            .then(res=>{
                this.setState({
                    files : res.data
                })
        ...
        return (
            <>
                <MDBContainer className="w-25 mt-5">
                    ...
                    <MDBBtn onClick={this.onClickUpload} style = {{float:'right'}} >Upload</MDBBtn>
                </MDBContainer>
